...
class ViewAwards extends StatefulWidget {
  SharedPreferences prefs;

  ViewAwards({this.prefs});

  final String title = 'Awards';

  @override
  State createState() => _ViewAwardsState();
}

class _ViewAwardsState extends State<ViewAwards> {
  @override
